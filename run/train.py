...
def load_data(config, data_sign="conll"):
    ...
    train_dataloader = dataloader.get_dataloader("dev1", use_cache=True)
    dev_dataloader = dataloader.get_dataloader("dev1", use_cache=True)
    test_dataloader = dataloader.get_dataloader("dev1", use_cache=True)
